...
class LocationService {
  ...
  public calculateEstimatedTime(
    ...
    const trafficFactor = 1.2 // Facteur de trafic (1.0 = pas de trafic, 2.0 = trafic dense)
    const roadConditionFactor = 1.1 // Facteur d'état des routes

    // Calcul du temps en minutes avec facteurs réalistes
    const timeInMinutes = Math.round((distance / averageSpeed) * 60 * trafficFactor * roadConditionFactor)

    // Ajouter un temps minimum de 2 minutes pour les trajets très courts
